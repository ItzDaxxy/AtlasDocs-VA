# Ignition - Knock Thresholds - High Timing - Cylinder 4
...
| **Dimensions** | 16x8 |
| **Data Unit** | NONE |
| **Source File** | `Ignition - Knock Thresholds - High Timing - Cylinder 4 - 2017 - RogueWRX.csv` |

## Description

This table defines the knock detection threshold for Cylinder 4 when timing is in the "high" (advanced) range, indexed by calculated load and RPM. The ECU compares knock sensor signal against this threshold to determine if knock is occurring.

**Purpose:**
- Sets knock detection sensitivity for Cylinder 4 at high timing
...
- Range: ~2560-3021 in preview (varies with RPM)
...
--------------------------------------------------------------------------------------------------------------------
    0.0000 |  2560.0000 |  2560.0000 |  2560.0000 |  2560.0000 |  2560.0000 |  2560.0000 |  2560.0000 |  2560.0000 |
  400.0000 |  2560.0000 |  2560.0000 |  2560.0000 |  2560.0000 |  2560.0000 |  2560.0000 |  2560.0000 |  2560.0000 |
  800.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |
 1200.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |
 1600.0000 |  2662.0000 |  2662.0000 |  2662.0000 |  2662.0000 |  2662.0000 |  2662.0000 |  2662.0000 |  2662.0000 |
 2000.0000 |  3021.0000 |  3021.0000 |  3021.0000 |  3021.0000 |  3021.0000 |  3021.0000 |  3021.0000 |  3021.0000 |
 2400.0000 |  3021.0000 |  3021.0000 |  3021.0000 |  3021.0000 |  3021.0000 |  3021.0000 |  3021.0000 |  3021.0000 |
 2800.0000 |  2816.0000 |  2816.0000 |  2816.0000 |  2816.0000 |  2816.0000 |  2816.0000 |  2816.0000 |  2816.0000 |
```
...
- Low RPM (0-400): ~2560 (lower engine noise)
- Mid RPM (800-1600): ~2637-2662
- Higher RPM (2000-2400): ~3021
...
**Cylinder 4 Location:**
FA20DIT Cylinder 4 = rear right. Right knock sensor monitors cylinders 2 and 4, so Cylinder 4 shares a sensor with Cylinder 2.

**Update Rate:** Evaluated every combustion event on Cylinder 4.

## Related Tables

- **[Ignition - Knock Thresholds - Low Timing - Cylinder 4](./ignition-knock-thresholds-low-timing-cylinder-4.md)**: Threshold when timing is retarded
- **[Ignition - Knock Thresholds - High Timing - Cylinder 2](./ignition-knock-thresholds-high-timing-cylinder-2.md)**: Cylinder 2 threshold (same sensor)
...
- **Knock Sum Cylinder 4**: Actual knock sensor reading
- **Feedback Knock Correction**: Timing retard from knock events
- **Fine Knock Learn Cylinder 4**: Learned correction for this cylinder
...
- Cylinders 2 and 4 share the right sensor

## Warnings

**Engine Safety Critical**: Knock thresholds are the primary knock protection. Incorrect values cause engine damage.

**Do Not Raise Blindly**: Raising thresholds masks real knock - only adjust with verified data.

**Professional Tuning Required**: Knock threshold calibration requires proper analysis tools and expertise.
