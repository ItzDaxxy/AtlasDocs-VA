# Ignition - Knock Thresholds - High Timing - Cylinder 3
...
| **Dimensions** | 16x8 |
| **Data Unit** | NONE |
| **Source File** | `Ignition - Knock Thresholds - High Timing - Cylinder 3 - 2017 - RogueWRX.csv` |

## Description

This table defines the knock detection threshold for Cylinder 3 when timing is in the "high" (advanced) range, indexed by calculated load and RPM. The ECU compares knock sensor signal against this threshold to determine if knock is occurring.

**Purpose:**
- Sets knock detection sensitivity for Cylinder 3 at high timing
...
- Range: ~2560-3635 in preview (varies with RPM)
...
--------------------------------------------------------------------------------------------------------------------
    0.0000 |  2611.0000 |  2611.0000 |  2611.0000 |  2611.0000 |  2611.0000 |  2611.0000 |  2611.0000 |  2611.0000 |
  400.0000 |  2611.0000 |  2611.0000 |  2611.0000 |  2611.0000 |  2611.0000 |  2611.0000 |  2611.0000 |  2611.0000 |
  800.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |  2637.0000 |
 1200.0000 |  2893.0000 |  2893.0000 |  2893.0000 |  2893.0000 |  2893.0000 |  2893.0000 |  2893.0000 |  2893.0000 |
 ...
 2400.0000 |  3635.0000 |  3635.0000 |  3635.0000 |  3635.0000 |  3635.0000 |  3635.0000 |  3635.0000 |  3635.0000 |
...
- Low RPM (0-800): ~2611-2637 (lower engine noise)
- Mid RPM (1200-2000): ~2893-3072
- Higher RPM (2400): ~3635
...
**Cylinder 3 Location:**
FA20DIT Cylinder 3 = rear left. Left knock sensor monitors cylinders 1 and 3, so Cylinder 3 shares a sensor with Cylinder 1.

**Update Rate:** Evaluated every combustion event on Cylinder 3.

## Related Tables

- **[Ignition - Knock Thresholds - Low Timing - Cylinder 3](./ignition-knock-thresholds-low-timing-cylinder-3.md)**: Threshold when timing is retarded
- **[Ignition - Knock Thresholds - High Timing - Cylinder 1](./ignition-knock-thresholds-high-timing-cylinder-1.md)**: Cylinder 1 threshold (same sensor)
...
- Cylinders 1 and 3 share the left sensor
